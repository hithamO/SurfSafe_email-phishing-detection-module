...
async def analyze_with_ai(analysis_data: Dict[str, Any], session: aiohttp.ClientSession) -> Dict[str, Any]:
    """
    Sends the comprehensive analysis data to the configured AI model
    ...
    logger.info(f"Sending request to AI model '{model}' at {api_url.split('/')[2]}...") 
